            ...
            <div className={styles.formContainer} >
                <form>
                    ...
                    <div className={styles.questionBox} >
                        ...
                        <input type="text" autoComplete="off" name="address" placeHolder="Address" onInput={handleChange} ></input>
                    </div>
                    <div className={styles.questionBox} >
                        <p className={styles.question} >Organs</p>
                        <input type="checkbox" name="organs[]" value="eyes"  onChange={handleChange2} />
                        <label for="eyes">Eyes</label><br />
                        <input type="checkbox" name="organs[]" value="kidney" onChange={handleChange2} />
                        <label for="kidney">Kidney</label><br />
                        <input type="checkbox" name="organs[]" value="liver" onChange={handleChange2} />
                        <label for="liver">Liver</label><br />
                        <input type="checkbox" name="organs[]" value="heart" onChange={handleChange2} /> 
                        <label for="heart">Heart</label><br />
                        <input type="checkbox" name="organs[]" value="lungs" onChange={handleChange2} />

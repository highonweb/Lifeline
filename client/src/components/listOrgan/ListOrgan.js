      ...
      <div className="listoforgans">
          ...
          <CardContent>
            <Typography variant="body2" color="textSecondary" component="p">
              <div className="insidecard">
                <div className="organ">Eye</div>

                <div className="number">Available: {eyes}</div>
              </div>
            </Typography>
          </CardContent>
        </Card>
        ...
        <Card className="details">
          ...
          <CardContent>
            <Typography variant="body2" color="textSecondary" component="p">
              <div className="insidecard">
                <div className="organ">Kidney</div>

                <div className="number">Available: {kidneys}</div>
              </div>
            </Typography>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <Typography variant="body2" color="textSecondary" component="p">
              <div className="insidecard">
                ...
                <div className="number">Available: {hearts}</div>
              </div>
            </Typography>
          </CardContent>
        </Card>
        ...
        <Card className="details">
          <CardMedia image={img_d} className={classes.media} />

          <CardContent>
            <Typography variant="body2" color="textSecondary" component="p">
              <div className="insidecard">
                <div className="organ">Lungs</div>

                <div className="number">Available: {lungs}</div>
              </div>
            </Typography>
          </CardContent>
        </Card>
        ...
        <Card className="details">
          <CardMedia image={img_e} className={classes.media} />
          ...
          <CardContent>
            <Typography variant="body2" color="textSecondary" component="p">
              <div className="insidecard">
                ...
                <div className="number">Available: {livers}</div>
              </div>
            </Typography>
          </CardContent>
        </Card>
      ...
      <div className="xyz">
        <Card className="details">
          <CardContent>
            <Typography variant="body2" color="textSecondary" component="p">
              <div className="insidecard">
                <div className="organ">Total Organs Available</div>
